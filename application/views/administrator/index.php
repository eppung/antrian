...
<head>
	...
	<!-- custom css -->
	<link rel="stylesheet" type="text/css" href="<?= base_url() . 'assets/vendors/styles/custom/erro-style.css' ?>">
			...
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						...
						<div style="float: right;"><button type="button" class="btn btn-outline-primary" title="Tambah Data" data-backdrop="static" data-toggle="modal" data-target="#poliklinik-modal"><i class="icon-copy fa fa-plus" aria-hidden="true" style="font-size: larger;"></i></button></div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						...
						<div style="float: right;"><button type="button" class="btn btn-outline-primary" title="Tambah Data" data-backdrop="static" data-toggle="modal" data-target="#loket-modal"><i class="icon-copy fa fa-plus" aria-hidden="true" style="font-size: larger;"></i></button></div>
